    ...
    render() {
        ...
        return (
            <Form id="pForm" style={{textAlign:'right'}} dir="rtl" onSubmit={(e) => e.preventDefault()}>
                ...
                <RI action={(e)=>this.setState({Gender:"נקבה"})} value="נקבה" image='images/female.jpg' width="120" height="120" size="8" color={this.state.Gender.includes("נקבה") ? '#66A5CC': "lightgray"}/>
                 <p>אני אישה</p>
                </div>
                
                <div style={{float:'right',width: "50%",padding: "5px"}}> 
                <RI action={(e)=>this.setState({Gender:"זכר"})} value="זכר" image='images/male.jpg' width="120" height="120" size="8" color={this.state.Gender.includes("זכר") ? '#66A5CC': "lightgray"}/>
                 <p>אני גבר</p>
                </div>
